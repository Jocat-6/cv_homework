...
if __name__ == '__main__':
    ...
    t1 = estimate_t(img, A)
    cv2.imwrite('./images/t1.jpg', t1 * 255)
    J1 = recovering_scene(img, t1, A)
    cv2.imwrite('./images/haze_free1.jpg', J1)

    # t2 = estimate_t_with_soft_matting(img, t1, A)
    t2 = TransmissionRefine(img, t1)
    cv2.imwrite('./images/t2.jpg', t2 * 255)
    J2 = recovering_scene(img, t2, A)
    cv2.imwrite('./images/haze_free2.jpg', J2)
